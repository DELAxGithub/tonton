...
class MealDataService {
  static const String _boxName =
      'tonton_meal_records'; // Must match the box opened in main.dart
  ...
  Future<void> init() async {
    if (isInitialized) {
      developer.log(
        'MealDataService already initialized.',
        name: 'TonTon.MealDataService',
      );
      return;
    }
    developer.log(
      'Initializing MealDataService...',
      name: 'TonTon.MealDataService',
    );
    ...
    if (Hive.isBoxOpen(_boxName)) {
      ...
      developer.log(
        'MealDataService: Box "$_boxName" reference obtained. Items: ${_mealRecordsBox?.length}',
        name: 'TonTon.MealDataService',
      );
    } else {
      developer.log(
        'MealDataService: Box "$_boxName" is not open. This should have been opened in main.dart. Attempting to open...',
        name: 'TonTon.MealDataService',
        level: 900,
      );
      try {
        ...
        developer.log(
          'MealDataService: Box "$_boxName" opened. Items: ${_mealRecordsBox?.length}',
          name: 'TonTon.MealDataService',
        );
      } catch (e, stack) {
        developer.log(
          'MealDataService: Failed to open box "$_boxName" in service init',
          error: e,
          stackTrace: stack,
          name: 'TonTon.MealDataService',
          level: 1000,
    ...
    if (!isInitialized) {
      developer.log(
        'MealDataService: Initialization failed, box "$_boxName" is not open.',
        name: 'TonTon.MealDataService',
        level: 1000,
      );
    } else {
      developer.log(
        'MealDataService initialized successfully.',
        name: 'TonTon.MealDataService',
      );
    }
  }
  ...
  Future<void> saveMealRecord(MealRecord record) async {
    if (!isInitialized) {
      developer.log(
        'MealDataService not initialized, cannot save record.',
        name: 'TonTon.MealDataService',
        level: 900,
      );
    ...
    developer.log(
      'MealDataService: Saving meal record with id: ${record.id}',
      name: 'TonTon.MealDataService',
    );
  ...
  Future<MealRecord?> getMealRecordById(String id) async {
    if (!isInitialized) {
      developer.log(
        'MealDataService not initialized, cannot get record by id.',
        name: 'TonTon.MealDataService',
        level: 900,
      );
      return null;
    ...
    developer.log(
      'MealDataService: Getting meal record by id: $id',
      name: 'TonTon.MealDataService',
    );
  ...
  Future<List<MealRecord>> getAllMealRecords() async {
    if (!isInitialized) {
      developer.log(
        'MealDataService not initialized, cannot get all records.',
        name: 'TonTon.MealDataService',
        level: 900,
      );
      return [];
    ...
    developer.log(
      'MealDataService: Getting all meal records. Count: ${_mealRecordsBox!.values.length}',
      name: 'TonTon.MealDataService',
    );
  ...
  Future<void> deleteMealRecord(String id) async {
    if (!isInitialized) {
      developer.log(
        'MealDataService not initialized, cannot delete record.',
        name: 'TonTon.MealDataService',
        level: 900,
      );
    ...
    developer.log(
      'MealDataService: Deleting meal record with id: $id',
      name: 'TonTon.MealDataService',
    );
  ...
  Future<void> close() async {
    ...
    developer.log(
      'MealDataService: Close called. Box management is typically global.',
      name: 'TonTon.MealDataService',
    );
  }
}
