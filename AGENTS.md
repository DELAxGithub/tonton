...
## HOW
Refer to the detailed rules and guides in `.Codex/rules/`:
- **General Rules**: [.Codex/rules/basic-rules.md](file://.Codex/rules/basic-rules.md)
- **Skills**: [.Codex/skills/](file://.Codex/skills/)
